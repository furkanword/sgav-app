<?php
    ...
    class Housetype{
        ...
        public function loadAllData(){
            $sql = "SELECT id_housetype,name_housetype,id_region FROM housetype";
            $stmt= self::$conn->prepare($sql);
            $stmt->execute();
        ...
        public function loadByIdData($id){
            $sql = "SELECT id_housetype,name_housetype,id_region FROM housetype WHERE id_housetype = :id_housetype";
            $stmt= self::$conn->prepare($sql);
